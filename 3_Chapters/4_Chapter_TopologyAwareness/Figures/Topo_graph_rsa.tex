...
\begin{figure}
    ...
    \end{tikzpicture}
    \caption{An example of eight process performing the RSA algorithm. Edge weights represent the amount of data in bytes transferd between ranks for an allreduce of size $n$.}
    \label{fig:graph-rsa}    
\end{figure}
