\begin{figure}
  ...
  \end{tikzpicture}
  \caption{Example of by-package, by-core and by-node initial mappings on 2 nodes with 2 2-core processors per node. 
  The blue dots represent package 0, and red dots represent package 1.
  }
