\begin{figure*}
    ...
    \begin{tikzpicture}
        ...
        \end{groupplot}
    \end{tikzpicture}
    \caption{Allreduce evaluation on Bleuga with 128 nodes. GPU nodes have 4 processes each, totaling 512 GPUs total, and CPU allocations have 32 processes per node for 4096 processes total. Message sizes range from 4B to 128MB on GPU resources, and 4B to 64MB on CPU resources.}
