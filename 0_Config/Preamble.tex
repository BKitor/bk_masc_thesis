...
\pgfplotscreateplotcyclelist{bk_pap_omb_cyclelist}{
    {magenta, densely dashdotdotted, mark=*}, 
    {orange, densely dashdotdotted, mark=*}, 
    {violet, densely dotted, mark=diamond*}, 
    {blue, mark=asterisk}, 
    {green!60!black, mark=asterisk}, 
    {black, densely dotted, mark=diamond*}
}

\pgfplotscreateplotcyclelist{bk_remap_omb_cdr_cyclelist}{
    {red, dashed, mark=*},
    {green, dashed, mark=square*},
    {orange, dashed, mark=diamond*},
    % {violet, mark=asterisk},
    {black, mark=x}
}

\pgfplotscreateplotcyclelist{bk_remap_omb_blg_cyclelist}{
    {red, dashed, mark=*},
    {green, dashed, mark=square*},
    {orange, dashed, mark=diamond*},
    {violet, mark=asterisk},
...
% \usepackage[ruled,vlined,linesnumbered,resetcount,algochapter,dotocloa]{algorithm2e}
...
\usepackage{tikz}
\usetikzlibrary{arrows,automata,arrows.meta,patterns,shapes.arrows}
